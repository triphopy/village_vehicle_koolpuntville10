...
function buildPrimaryOcrPrompt() {
  return 'ดูภาพนี้แล้วอ่านเฉพาะเลขทะเบียนรถที่เห็นในภาพ\n' +
    ...
    'ถ้าเห็นตัวอักษรและตัวเลขค่อนข้างชัด ให้ตอบตามที่เห็นในภาพก่อน\n' +
    'ให้ตอบ "null" เฉพาะเมื่ออ่านไม่ได้จริงๆ หรือไม่เห็นป้ายชัดพอ\n' +
    ...
    'ถ้าอ่านไม่ชัดจริงๆ ค่อยตอบ "null"\n' +
